...
{
    public abstract class PaginatedModule<TItemPresenter, TItemViewModel> : MonoBehaviour
        ...
        where TItemViewModel : IPaginatedItemViewModel
    {
        ...
        public virtual void Initialize(IDataProvider<TItemViewModel> provider, string noContentMessage = "")
        {
