namespace FormForge.Collections
{
    ...
    {
        public static readonly Vector3 AutoContainerPosition = new Vector3(-9999, 0, 0);

        private Transform m_container;
        private bool m_isGameObject = false;

        /// <summary>
        /// Returns the type of the object managed by the Pool
        /// </summary>
        ...
        public Pool(uint initialSize)
        {
            ...
            Generator = new DefaultGenerator<T>(this);
        ...
        public Pool(uint initialSize, GameObject template, Transform container = null, bool hideContainerInHierarchy = true)
        {
            ...
            m_container = container != null ? container : CreateContainer(template.name);

            if (hideContainerInHierarchy)
            {
                m_container.hideFlags = HideFlags.HideInHierarchy;
            }

            Generator = new UnityGenerator(this, template, m_container);
            m_isGameObject = true;
        ...
        public override void Recycle(IPoolable obj)
        {
            ...
            {
                Transform objTransform = (obj as MonoBehaviour).transform;
                objTransform.SetParent(m_container);
        ...
        /// </summary>
        public override void RecycleAndDestroyAll()
        {
            base.RecycleAndDestroyAll();
        ...
        private Transform CreateContainer(string objectName)
        {
            ...
            container.transform.position = AutoContainerPosition;
